...
volatile uint8_t flag_p=0;
volatile uint8_t flag_c=0;
volatile uint8_t flag_j=0;
volatile uint8_t flag_m=0;

volatile uint8_t interrupt_game=0;
volatile char estado='m';

 //SONIDO DE PERDER
 int gameover_melody[]= {
	    392, 329, 261, 220,   // descenso de notas (a la mitad de la frecuencia)
	    174, 146, 130, 110, 0      // pausa final (en un tono grave)
	};
int gameover_duration[]= {
	   200, 200, 200, 200,   // duraciones de notas (descenso rápido)
	    400, 400, 400, 600 };        // pausa final

//MELODÍA GENERAL DEL JUEGO
int game_melody[]= {523, 659, 784, 523, 659, 784, 880, 784, 1046, 880, 784, 659};
int game_duration[]= {400,   200,   200,   200,   200,   200,   200,   200,    200,   200,   200,   400};
...
//MENU
int menu_melody[]={220, 261, 329, 196, 175, 293,220, 261, 293, 261, 220, 0};
int menu_duration[]={200, 200, 200, 200, 200, 200,200, 200, 200, 200, 200, 400};
...
//ambos pierden
int lose_melody[]={
   392, 370, 349, 330, 311, 294, // G4 → F#4 → F4 → E4 → D#4 → D4
   262                          // C4 (nota final grave y larga)
};
int lose_duration[]={
